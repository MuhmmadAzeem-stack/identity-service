...
class PermissionServiceDetailTest {
    ...
    @Mock
    private com.omnicore.identity.common.MessageResolver messageResolver;
    ...
    void getPermissionDetailShouldFetchRelationsAndMapResponse() {
        ...
        PermissionSummaryResponse dependentSummary =
            new PermissionSummaryResponse(9L, "CREATE_USER", "USER", "CREATE", "Create users", true, true);
        RoleSummaryResponse roleSummary =
            new RoleSummaryResponse(1L, "SUPER_ADMIN", "Full system access", true, true);
        PermissionDetailResponse detailResponse = new PermissionDetailResponse(
            9L,
            "CREATE_USER",
            "USER",
            "CREATE",
        ...
        when(rolePermissionRepository.findActiveRolesByPermissionId(9L))
    ...
    void getPermissionDetailShouldThrowWhenPermissionNotFound() {
        ...
        assertThrows(PermissionNotFoundException.class, () -> permissionService.getPermissionDetail(999999L));
    }
    ...
    void getPermissionDetailShouldTreatSoftDeletedPermissionAsNotFound() {
        ...
        assertThrows(PermissionNotFoundException.class, () -> permissionService.getPermissionDetail(5L));
    }
    ...
    void getPermissionDetailShouldRejectNullId() {
        IllegalArgumentException exception = assertThrows(
            ...
            () -> permissionService.getPermissionDetail(null)
        );
