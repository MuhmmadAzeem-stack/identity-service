...
public final class AuthorityNames {
  ...
  public static final String ASSIGN_ROLE_PERMISSION =
      authority(RbacAction.ASSIGN, RbacModule.ROLE_PERMISSION);
  public static final String REMOVE_ROLE_PERMISSION =
      authority(RbacAction.REMOVE, RbacModule.ROLE_PERMISSION);
  ...
  public static final String CREATE_PERMISSION =
      authority(RbacAction.CREATE, RbacModule.PERMISSION);
  public static final String UPDATE_PERMISSION =
